...
menu() {
    ...
    echo -e "# ${GREEN}AI降临派${PLAIN}: 宝藏博客&宝藏商店联合提供                                                 #"
    echo -e "# ${GREEN}宝藏博客${PLAIN}: https://gpt2031.vip                                                   #"
    echo -e "# ${GREEN}宝藏商店${PLAIN}: https://gpt2031.cn                                                    #"
    echo -e "# ${GREEN}宝藏商店AI人工智能免费提供苹果美区账号${PLAIN}: http://43.163.235.148:2031/get-account-info  #"
    echo "#############################################################"
    echo ""
